...
name: Anti-gravity
company: Google
description: Agent-first AI-powered IDE with autonomous multi-agent orchestration
website: https://www.antigravityide.app
hasIDEExtension: false
supportedIDEs:
  - Anti-gravity (Standalone)
pricing: Free
language:
  - Python
  - JavaScript
...
Google Anti-gravity is the first agent-first AI-powered IDE designed to transform developer workflows through autonomous agents that plan, execute, and verify software tasks. Built as a fork of VS Code, it provides familiar editing experience enhanced with revolutionary AI agent capabilities.
...
- **Trust & Transparency**: Every agent action documented with human-readable artifacts
